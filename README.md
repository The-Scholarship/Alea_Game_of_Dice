...
It's also a fun way to discover the history of dice games and to share that knowledge with others. Additionally, this game can serve as a portfolio project for game development, showcasing skills in game design, programming, and historical research.

## Deployment on Itch.io

The game is currently in development and will be deployed onto Itch.io once it's ready. Please come back later to check it out and play the game!

## Contributing

Feel free to test the game and report any bugs or improvement ideas with Github issues. 
